...
# @Date : 2022-07-07
# @Author : zyz
# @File : Constrained Image Construction Models

import torch
import torch.nn as nn
from torchvision import models
from models.quantize import VQVAEQuantize
...
class CVAE(nn.Module):
	def __init__(self, n_dim1, n_dim2, n_embedding1, n_embedding2, size, seed=0):
		...
		self.layer1 = nn.Sequential(*self.baselayer[:7])
		self.layer2 = nn.Sequential(*self.baselayer[7:8])

		self.layer_11 = nn.Sequential(nn.Conv2d(256, n_dim1, kernel_size=(3, 3), padding=1),
	...
	def forward(self, x):
		...
		x2 = self.sampleing(mu2, var2)
		x1 = self.sampleing(mu1, var1)
